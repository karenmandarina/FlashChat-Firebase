...
public class PostNotificationReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        Notification notification = new Notification.Builder(context)
                .setSmallIcon(com.karenmandarina.flashchatnewfirebase.R.mipmap.ic_launcher)
        ...
        Toast.makeText(context, context.getString(com.karenmandarina.flashchatnewfirebase.R.string.notification_posted), Toast.LENGTH_SHORT).show();
    }
}
